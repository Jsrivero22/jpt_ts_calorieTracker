...
export const Form = ({ dispatch, state }: FormProps ) => {
    ...
    const nameButtonSaveForm = () => {
        const category = activity.category === 1 ? 'Comida' : 'Ejercicio';
        return state.activeId ? `Modificar ${ category }` : `Guardar ${ category }`
    }
